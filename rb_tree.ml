...
let test0 = t0 = Node (Empty, "ab", 12, Black, Empty)
let test1 = t1 = Node (Empty, "ab", 12, Black, Node (Empty, "bc", 23, Red, Empty))
let test2 = t2 = Node (Node (Empty, "ab", 12, Black, Empty), "bc", 23, Black, Node (Empty, "cd", 34, Black, Empty))
let test3 = t3 = Node (Node (Empty, "ab", 12, Black, Empty), "bc", 23, Black, Node (Empty, "cd", 34, Black, Node (Empty, "de", 45, Red, Empty)))
let test4 = t4 = Node (Node (Empty, "ab", 12, Black, Empty), "bc", 23, Black, Node (Node (Empty, "cb", 89, Red, Empty), "cd", 34, Black, Node (Empty, "de", 45, Red, Empty)))
